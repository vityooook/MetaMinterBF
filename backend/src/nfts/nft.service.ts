...
export class NftService {
  ...
  private async collectionPayload(collectionId: string, userAddress: string) {
    // TESTNET: kQCEHELISOI5SD5_s1CjAl859TdjfDUABbZ2yaFAlrgnoJdL
    // MAINNET: EQBz57ewqkr-GC_RMRHybM0MGXvEm6pVvzh6bWpzBm3xAbJz
    const admin_address = "0QC1xFj48WvQISDIP7zwrgj1DOwmKusRCL4JDGhwkwZL1Tmk";
    ...
    const collectionContent =
      "https://richcats.app/api/cat/bg0037:bd0006:ey0065:te0019:wh0002/json";
    const itemContent =
      "https://richcats.app/api/cat/bg0037:bd0006:ey0065:te0019:wh0002/json";
    ...
    return { nftCollectionAddress, stateInitCell };
  }

  async generateCollectionPayload(collectionId: string, userAddress: string) {
    const payload = await this.collectionPayload(collectionId, userAddress);
